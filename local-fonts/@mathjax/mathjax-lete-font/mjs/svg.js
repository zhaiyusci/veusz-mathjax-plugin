...
import { CommonMathJaxLeteFontMixin } from './common.js';
...
const Base = CommonMathJaxLeteFontMixin(SvgFontData);
export class MathJaxLeteFont extends Base {
    constructor(options = {}) {
        super(options);
...
MathJaxLeteFont.NAME = 'MathJaxLete';
MathJaxLeteFont.OPTIONS = Object.assign(Object.assign({}, Base.OPTIONS), {});
MathJaxLeteFont.defaultDelimiters = delimiters;
MathJaxLeteFont.defaultChars = {
    'normal': normal,
    'bold': bold,
    'italic': italic,
...
MathJaxLeteFont.dynamicFiles = SvgFontData.defineDynamicFiles([]);
