...
import { CommonMathJaxSans2FontMixin } from './common.js';
...
const Base = CommonMathJaxSans2FontMixin(SvgFontData);
export class MathJaxSans2Font extends Base {
    constructor(options = {}) {
        super(options);
...
MathJaxSans2Font.NAME = 'MathJaxSans2';
MathJaxSans2Font.OPTIONS = Object.assign(Object.assign({}, Base.OPTIONS), {});
MathJaxSans2Font.defaultDelimiters = delimiters;
MathJaxSans2Font.defaultChars = {
    'normal': normal,
    'bold': bold,
    'italic': italic,
...
MathJaxSans2Font.dynamicFiles = SvgFontData.defineDynamicFiles([]);
