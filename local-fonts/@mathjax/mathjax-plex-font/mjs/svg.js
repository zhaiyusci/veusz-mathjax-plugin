...
import { CommonMathJaxPlexFontMixin } from './common.js';
...
const Base = CommonMathJaxPlexFontMixin(SvgFontData);
export class MathJaxPlexFont extends Base {
    constructor(options = {}) {
        super(options);
...
MathJaxPlexFont.NAME = 'MathJaxPlex';
MathJaxPlexFont.OPTIONS = Object.assign(Object.assign({}, Base.OPTIONS), {});
MathJaxPlexFont.defaultDelimiters = delimiters;
MathJaxPlexFont.defaultChars = {
    'normal': normal,
    'bold': bold,
    'italic': italic,
...
MathJaxPlexFont.dynamicFiles = SvgFontData.defineDynamicFiles([]);
