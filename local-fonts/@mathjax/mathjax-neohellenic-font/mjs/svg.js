...
import { CommonMathJaxNeohellenicFontMixin } from './common.js';
...
const Base = CommonMathJaxNeohellenicFontMixin(SvgFontData);
export class MathJaxNeohellenicFont extends Base {
    constructor(options = {}) {
        super(options);
...
MathJaxNeohellenicFont.NAME = 'MathJaxNeohellenic';
MathJaxNeohellenicFont.OPTIONS = Object.assign(Object.assign({}, Base.OPTIONS), {});
MathJaxNeohellenicFont.defaultDelimiters = delimiters;
MathJaxNeohellenicFont.defaultChars = {
    'normal': normal,
    'bold': bold,
    'italic': italic,
...
MathJaxNeohellenicFont.dynamicFiles = SvgFontData.defineDynamicFiles([]);
