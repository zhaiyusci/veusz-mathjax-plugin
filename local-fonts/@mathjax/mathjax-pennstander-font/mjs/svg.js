...
import { CommonMathJaxPennstanderFontMixin } from './common.js';
...
const Base = CommonMathJaxPennstanderFontMixin(SvgFontData);
export class MathJaxPennstanderFont extends Base {
    constructor(options = {}) {
        super(options);
...
MathJaxPennstanderFont.NAME = 'MathJaxPennstander';
MathJaxPennstanderFont.OPTIONS = Object.assign(Object.assign({}, Base.OPTIONS), {});
MathJaxPennstanderFont.defaultDelimiters = delimiters;
MathJaxPennstanderFont.defaultChars = {
    'normal': normal,
    'bold': bold,
    'italic': italic,
...
MathJaxPennstanderFont.dynamicFiles = SvgFontData.defineDynamicFiles([]);
