...
import { CommonMathJaxSans3FontMixin } from './common.js';
...
const Base = CommonMathJaxSans3FontMixin(SvgFontData);
export class MathJaxSans3Font extends Base {
    constructor(options = {}) {
        super(options);
...
MathJaxSans3Font.NAME = 'MathJaxSans3';
MathJaxSans3Font.OPTIONS = Object.assign(Object.assign({}, Base.OPTIONS), {});
MathJaxSans3Font.defaultDelimiters = delimiters;
MathJaxSans3Font.defaultChars = {
    'normal': normal,
    'bold': bold,
    'italic': italic,
...
MathJaxSans3Font.dynamicFiles = SvgFontData.defineDynamicFiles([]);
