...
import { CommonMathJaxLucioleFontMixin } from './common.js';
...
const Base = CommonMathJaxLucioleFontMixin(SvgFontData);
export class MathJaxLucioleFont extends Base {
    constructor(options = {}) {
        super(options);
...
MathJaxLucioleFont.NAME = 'MathJaxLuciole';
MathJaxLucioleFont.OPTIONS = Object.assign(Object.assign({}, Base.OPTIONS), {});
MathJaxLucioleFont.defaultDelimiters = delimiters;
MathJaxLucioleFont.defaultChars = {
    'normal': normal,
    'bold': bold,
    'italic': italic,
...
MathJaxLucioleFont.dynamicFiles = SvgFontData.defineDynamicFiles([]);
